		...
		<li <?php comment_class(); ?>>
	    	...
	    	<!--<a name="comment-<?php comment_ID() ?>"></a>-->
	      	...
	      	<div id="li-comment-<?php comment_ID() ?>" class="comment-container">      	
	                ...
	                <small class="commentmetadata"><?php echo get_comment_date(get_option( 'date_format' )) ?> <?php _e( 'at', 'woothemes' ); ?> <?php echo get_comment_time(get_option( 'time_format' )); ?></small>
