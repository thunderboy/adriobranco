		...
		<tbody>
				...
				foreach ($woocommerce->cart->get_cart() as $cart_item_key => $values) :
					...
					if ($_product->exists() && $values['quantity']>0) :
						...
						<tr>
							...
							<td class="product-subtotal"><b><?php echo woocommerce_price($_product->get_price()*$values['quantity']); ?></b></td>
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<input type="submit" class="button" name="update_cart" value="<?php _e('Update', 'woothemes'); ?>" /> 
