...
add_action( 'woocommerce_after_single_product_summary', 'woocommerce_product_reviews_panel', 60 );
...
/* Product Add to cart */
add_action( 'woocommerce_after_single_product_summary', 'woocommerce_template_single_add_to_cart', 40, 2 );
